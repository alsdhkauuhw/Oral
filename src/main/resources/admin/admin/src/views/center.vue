<template>
  <div>
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" label-width="80px">
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="flag == 'huiyuan'" label="会员号" prop="huiyuanhao">
            <el-input v-model="ruleForm.huiyuanhao" readonly placeholder="会员号" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'huiyuan'" label="年龄" prop="nianling">
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'huiyuan'" label="性别" prop="xingbie">
            <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
              <el-option v-for="(item, index) in huiyuanxingbieOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item v-if="flag == 'huiyuan'" label="邮箱" prop="youxiang">
            <el-input v-model="ruleForm.youxiang" placeholder="邮箱" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="flag == 'huiyuan'" label="积分" prop="jifen">
...
export default {
  ...
  methods: {
    onUpdateHandler() {
      if ((!this.ruleForm.huiyuanhao) && 'huiyuan' == this.flag) {
        this.$message.error('会员号不能为空');
        return
      }
      ...
      if ('huiyuan' == this.flag && this.ruleForm.jifen && (!isIntNumer(this.ruleForm.jifen))) {
