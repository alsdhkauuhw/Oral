    ...
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="就诊医生" prop="doctor">
              <el-select v-model="ruleForm.doctor" placeholder="医生" style="width: 200px">
              <el-option v-for="item in allDoctor" :key="item" :label="item" :value="item" />
            </el-select>
            </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item class="date" v-if="type != 'info'" label="复查就诊时间" prop="fuchajiuzhenshijian">
            <el-date-picker format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" v-model="ruleForm.fuchajiuzhenshijian"
              type="date" placeholder="复查就诊时间">
            </el-date-picker>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.fuchajiuzhenshijian" label="复查就诊时间" prop="fuchajiuzhenshijian">
              <el-input v-model="ruleForm.fuchajiuzhenshijian" placeholder="复查就诊时间" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type != 'info'" label="提醒内容" prop="tixingneirong">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="提醒内容"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type != 'info'" label="注意事项" prop="zhuyishixiang">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="注意事项"
...
export default {
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'fuchajiuzhenshijian') {
            this.ruleForm.fuchajiuzhenshijian = obj[o];
            this.ro.fuchajiuzhenshijian = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
      console.log(this.ruleForm.doctor)
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fuchatixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuchatixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
