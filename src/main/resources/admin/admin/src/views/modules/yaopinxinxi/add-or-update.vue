          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="功能主治" prop="gongnengzhuzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="功能主治"
                  v-model="ruleForm.gongnengzhuzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongnengzhuzhi" label="功能主治" prop="gongnengzhuzhi">
                    <span>{{ruleForm.gongnengzhuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="不良反应" prop="buliangfanying">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.buliangfanying" label="不良反应" prop="buliangfanying">
                    <span>{{ruleForm.buliangfanying}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="禁忌事项" prop="jinjishixiang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="禁忌事项"
                  v-model="ruleForm.jinjishixiang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinjishixiang" label="禁忌事项" prop="jinjishixiang">
                    <span>{{ruleForm.jinjishixiang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='gongnengzhuzhi'){
            this.ruleForm.gongnengzhuzhi = obj[o];
	    this.ro.gongnengzhuzhi = true;
            continue;
          }
	            	            if(o=='buliangfanying'){
	    ...
	    this.ro.buliangfanying = true;
            continue;
	            	            ...
	            	            if(o=='jinjishixiang'){
            this.ruleForm.jinjishixiang = obj[o];
	    this.ro.jinjishixiang = true;
            continue;
          }
	            	            if(o=='beizhu'){
