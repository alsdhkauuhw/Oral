<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="会员号" prop="huiyuanhao">
            <el-input v-model="ruleForm.huiyuanhao" placeholder="会员号" clearable :readonly="ro.huiyuanhao"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="会员号" prop="huiyuanhao">
              <el-input v-model="ruleForm.huiyuanhao" placeholder="会员号" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
        ...
        <!-- 更改 -->
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="就诊医生" prop="doctor">
            <el-select v-model="ruleForm.doctor" placeholder="医生" style="width: 200px">
              <el-option v-for="item in allDoctor" :key="item" :label="item" :value="item" />
            </el-select>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="性别" prop="doctor">
              <el-select v-model="ruleForm.doctor" placeholder="医生" style="width: 200px">
                <el-option v-for="item in allDoctor" :key="item" :label="item" :value="item" />
              </el-select>
            </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="身份证" prop="shenfenzheng">
            <el-input v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable
              :readonly="ro.shenfenzheng"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="date" v-if="type != 'info'" label="就诊时间" prop="jiuzhenshijian">
            <el-date-picker format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" v-model="ruleForm.jiuzhenshijian"
              type="date" placeholder="就诊时间">
            </el-date-picker>
          </el-form-item>
          <div v-else>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type != 'info'" label="药品用量" prop="yaopinyongliang">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="药品用量"
              v-model="ruleForm.yaopinyongliang">
            </el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.yaopinyongliang" label="药品用量" prop="yaopinyongliang">
              <span>{{ ruleForm.yaopinyongliang }}</span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type != 'info'" label="就诊信息" prop="jiuzhenxinxi">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="就诊信息"
              v-model="ruleForm.jiuzhenxinxi">
            </el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.jiuzhenxinxi" label="就诊信息" prop="jiuzhenxinxi">
              <span>{{ ruleForm.jiuzhenxinxi }}</span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  methods: {
    ...
    select() {
      this.$http({
        ...
        if (data && data.code === 0) {
          this.allDoctor = data.doctorname;
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'yaopinyongliang') {
            this.ruleForm.yaopinyongliang = obj[o];
            this.ro.yaopinyongliang = true;
            continue;
          }
          if (o == 'jiuzhenxinxi') {
            this.ruleForm.jiuzhenxinxi = obj[o];
            this.ro.jiuzhenxinxi = true;
            continue;
          }
          if (o == 'jiuzhenshijian') {
    ...
    info(id) {
      this.$http({
        url: `binglijiuzhenxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `binglijiuzhenxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.binglijiuzhenxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
