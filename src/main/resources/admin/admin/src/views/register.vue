  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">口腔管家平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.huiyuanhao" class="input" type="text" placeholder="会员号">
			   </div>
			 </div> -->
			<el-form-item label="会员号" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuanhao" autocomplete="off" placeholder="会员号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='huiyuan'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
                              if((!this.ruleForm.huiyuanhao) && `huiyuan` == this.tableName){
        ...
        return
                                          ...
                                          if(`huiyuan` == this.tableName && this.ruleForm.jifen&&(!this.$validate.isIntNumer(this.ruleForm.jifen))){
